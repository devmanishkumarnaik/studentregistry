...
//               {/* Status dot */}
//               <div style={{ display:"flex", alignItems:"center", gap:6, background:"#0a1628", border:"1px solid #1e3a5f", borderRadius:20, padding:"5px 12px" }}>
//                 <span style={{ width:7, height:7, borderRadius:"50%", background:"#4ade80", boxShadow:"0 0 5px #4ade80", flexShrink:0 }} />
//                 <span style={{ fontFamily:"'Inter',sans-serif", fontSize:11, color:"#4ade80", fontWeight:600 }}>Online</span>
//               </div>
